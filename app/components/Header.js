      ...
      <header className="fixed top-0 w-full bg-dark/80 backdrop-blur-sm z-50">
        <nav className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <Link href="/" className="relative z-50 hover:opacity-90 transition-opacity flex items-center">
              <Image
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button 
                ...
                className="bg-primary text-light px-6 py-2 rounded-lg hover:bg-primary/90 transition-colors"
              >
                Hemen Kaydolun
              </button>
            </div>
          ...
          <div className={`fixed inset-0 bg-dark transition-all duration-300 md:hidden ${
            ...
            <div className="flex flex-col items-center justify-center min-h-screen space-y-8 p-6">
              ...
              <button 
                onClick={() => setShowContactModal(true)}
                className="bg-primary text-light px-8 py-3 rounded-lg hover:bg-primary/90 transition-colors"
              >
                Hemen Kaydolun
              </button>
            </div>
